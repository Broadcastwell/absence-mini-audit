...
export const LEXICON = [
  ...
  { id: "core_hr", group: "horizontal", label: "HR software", terms: ["human capital management", "hris", "hcm", "human resources", "hr software", "core hr", "hr and finance", "hr", "people management", "employee records", "people platform", "hr platform", "onboarding"] },
  ...
  { id: "video_conferencing", group: "horizontal", label: "video conferencing software", terms: ["video conferencing", "video meetings", "webinars", "online meetings", "virtual meetings", "meeting rooms"] },
  { id: "business_phone", group: "horizontal", label: "business phone system", terms: ["business phone", "voip", "cloud phone", "phone system", "ucaas", "unified communications"] },
  { id: "contact_center", group: "horizontal", label: "contact center software", terms: ["contact center", "call center", "ccaas", "omnichannel support", "ivr"] },
  ...
  { id: "life_sciences", group: "vertical", label: "life sciences software", terms: ["life sciences", "pharmaceutical", "pharma", "biotech", "medtech", "medical device", "regulatory submissions"] },
