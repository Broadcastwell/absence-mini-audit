...
const RESPONSES = {
  ...
  address_limit: "You have already run today's check for this address. Read the chapter your result pointed to, or request the four-engine Diagnostic.",
  ip_limit: "This network has reached its daily check limit. Try again tomorrow.",
  global_limit: "Today's runs are full. Come back after 00:00 UTC, or request the four-engine Diagnostic.",
  upstream: "We could not complete this run. Try again, or email hello@broadcastwell.com.",
};
