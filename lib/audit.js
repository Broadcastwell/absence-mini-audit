...
// exactly as its Build The Question Set node builds them (Absence Mini Audit, read on 14
// September 2026). The upstream answers with counts only: its last node keeps six keys
// and drops every per question row. The page needs the ten questions, so they are
// rebuilt here from the same category the upstream received.
